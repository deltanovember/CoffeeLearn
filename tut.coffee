...
promptForTile1 = ->
  console.log "Please enter through coordinates for the first tile"
  inputCallback = (input) ->
    promptForTile2() if strToCoordinates input

promptForTile2 = ->
  console.log "Please enter through coordinates for the second tile"
  inputCallback = (input) ->
    if strToCoordinates input
      console.log "Swapping tiles...done!r"
      promptForTile1()
